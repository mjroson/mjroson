  const projects = [
  {
    ...
    "tecnologies": ["Linux", "Docker", "Django", "Celery", "RabbitMQ", "Django Rest Framework", "React", "Antd", "Sass"]
  },
  {
    "id": "2",
    "from": "2017-11-01",
  ...
  El mayor desafío que presentó este proyecto fue el despliegue del proyecto, ya que el SDK de procesamiento de pago contaba con 4 instancias de server diferentes, y nuestro proyecto con 3 instancias más, usando un balanceador de carga y planificado para pasar la homologación de PCI DSS (Payment Card Industry Data Security Standard).`,
    "tecnologies": ["Linux", "AWS", "Docker", "Django", "Celery", "RabbitMQ", "SDK de procesador de pago", "React", "Antd", "Redux", "Sass"]
  },
  {
    "id": "3",
    "from": "2017-01-01",
    ...
    "tecnologies": ["Linux", "Docker", "Django", "PostGis", "Celery", "RabbitMQ", "django-channel", "django rest framework", "Jquery", "Vuejs", "GoogleMaps", "Bootstrap", "Sass"]
  },
  {
    "id": "4",
    "from": "2016-11-01",
  ...
  El mayor desafío que presentó esta aplicación fue tener un sistema eficiente y controlado para obtener las transacciones mediante scraper, con clientes que procesan miles de transacciones por día.`,
    "tecnologies": ["Linux", "Docker", "Django", "Beautiful Soup", "PostgresQL", "Celery", "RabbitMQ", "Django Rest Framework", "Jquery", "Bootstrap"]
  },
  {
    "id": "5",
    "from": "2014-10-01",
  ...
  Compralo ahi es una aplicación intuitiva que permite al usuario encontrar fácilmente en su cercanía lo que están buscando interactuando con un mapa y diferentes filtros. Una vez que el usuario ha encontrado lo que está buscando, tiene la posibilidad de contactarse con el dueño del anuncio utilizando un sistema de mensajes privados o públicos. Por otra parte, un usuario puede generar un catálogo dinámicamente especificando los avisos que quiere mostrar, la disposición con la que se muestra, un logo, colores y diferentes aspectos del estilo.`,
    "tecnologies": [ "Django", "Django Rest Framework", "Celery", "Haystack", "Elasticsearch", "Postgresql", "Angularjs", "Jquery", "Bootstrap", "OpenStreetMap", "Leaflet", "LESS"]
  },
  {
    "id": "6",
    "from": "2016-12-01",
    ...
    "tecnologies": ["Django", "Bootstrap", "Angularjs", "API REST", "Mercadopago payment gateway"]
  },
  {
    "id": "7",
    "from": "2015-04-01",
    ...
    "tecnologies": ["Django", "bootstrap", "Django Rest", "Celery", "Linux", "Nginx", "Django CMS", "Integration with Epay and propay payment gateways"]
  },
  {
    "id": "8",
    "from": "2018-07-01",
    ...
    "tecnologies": ["Angularjs", "Ionic", "Cordova"]
  },
  {
    "id": "9",
    "from": "2018-07-01",
    ...
    "tecnologies": ["Ionic", "Cordova", "AngularJs", "OpenStreetMap", "Leaflet"]
  },
  {
    "id": "10",
    "from": "2018-07-01",
...
Y un CMS con la posibilidad de generar paginas dinámicamente y con diversos plugins integrados del propio ecommerce, de bootstrap en general, formularios dinámicos, redes sociales, mapas, etc.`,
    "tecnologies": ["Django", "Django CMS", "Rest Django Framework", "Celery", "Postgres", "Bootstrap", "Angularjs"]
  },
  {
    "id": "11",
    "from": "2018-07-01",
    ...
    "tecnologies": ["Django", "Django framework Rest", "celery", "MongoDB", "Jquery", "AngularJS", "Bootstrap"]
  },
  {
    "id": "12",
    "from": "2018-07-01",
    ...
    "tecnologies": ["Django", "DjangoAdmin" , "celery", "sqlite", "Jquery", "Jquery UI", "FullCalendar.io"]
  },
    ];
