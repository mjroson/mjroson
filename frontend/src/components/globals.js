...
export const SocialListItem = styled(ListItem)(theme => ({
  color: "red !important",
  '&:hover svg':{
...
export const SocialNetworkListItems = (
    <React.Fragment>
      <SocialListItem component="a" href="https://www.linkedin.com/in/matiasroson/" target="_blank">
        <ListItemIcon>
          <SvgIcon>
      ...
      <SocialListItem component="a" href="https://github.com/mjroson" target="_blank">
        <ListItemIcon>
          <SvgIcon>
      ...
      <SocialListItem component="a" href="https://bitbucket.org/mjroson/" target="_blank">
        <ListItemIcon>
          <SvgIcon >
      ...
      <SocialListItem component="a" href="mailto:matiroson@gmail.com" target="_blank">
        <ListItemIcon>
          <MailIcon/>
        </ListItemIcon>
