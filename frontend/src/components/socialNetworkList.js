...
export const socialNetworkListItems = (
  <React.Fragment>
    <ListItem button component="a" href="https://www.linkedin.com/in/matiasroson/" target="_blank">
      <ListItemIcon>
        <SvgIcon>
    ...
    <ListItem button component="a" href="https://github.com/mjroson" target="_blank">
      <ListItemIcon>
        <SvgIcon>
    ...
    <ListItem button component="a" href="https://bitbucket.org/mjroson/" target="_blank">
      <ListItemIcon>
        <SvgIcon >
    ...
    <ListItem button component="a" href="mailto:matiroson@gmail.com" target="_blank">
      <ListItemIcon>
        <MailIcon/>
      </ListItemIcon>
